...
const SECTION_ORDER_OPTIONS = [
  { value: "experience,project,skill,education", label: "Expériences → Projets → Compétences → Formation" },
  { value: "education,experience,project,skill", label: "Formation → Expériences → Projets → Compétences" },
  { value: "skill,experience,project,education", label: "Compétences → Expériences → Projets → Formation" },
];

export const CvCreateForm: React.FC = () => {
  ...
  async function onSubmit(values: z.infer<typeof cvSchema>) {
    toast.promise(createCv.mutateAsync(values), {
      loading: "Création du CV...",
